// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮SALEH BOT INC 2022 ®️ALL RIGHTS RESERVED
//▮
...
│🎭 Creator : ${packname}
║🎭 Owner :  ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ
│🎭 Owner Number : 088212430786
║🎭 Prefix :MULTI
│▬▭「 ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ️ 」▭▬
║
│ Chenel : https://youtube.com/channel/UCmqwWI-q6eS0eCPDSMdvqrQ
║
┗━━━━━━━━━━━━━━━━━━⬣
...
quickReplyButton: {
displayText: 'ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ',
id: 'pemcet'
}
}]
fatihgans = fs.readFileSync('./lib/assets/logo.jpg'), 
kurr.send5ButImg(m.chat, anu, ` BOT HOSTING BY SALEH🤖 `, fatihgans, btn)
break
...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://vil.kemitraan-berbayar.ml:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:KEMITRAAN-BERBAYAR").toString("base64") } })
      ...
      break
                                          case 'pemcet':
                                          m.reply(`GG KAN BOT NYA SUBS YT GW DONG BIAR NAMBAH GG\nYT : https://youtube.com/channel/UCmqwWI-q6eS0eCPDSMdvqrQ`)
                                          break
case 'webp': {
...
case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Group`, '© 𝑪𝒐𝒑𝒚𝒓𝒊𝒈𝒉𝒕 𝑩𝒚 Saleh✓', m)
...
case 'loginwhm':
if(from != "ID GROUPNYA") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://vil.kemitraan-berbayar.ml:2087/`)
                                          break
case 'logincpanel':
if(from != "ID GROUPNYA") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://vil.kemitraan-berbayar.ml:2083/`)
                                          break
case 'listpc': {
if (!isCreator) throw mess.owner
...
contoh : https://salehganteng.barux2022.tk
...
┃┊◎ .domain6 |  
┃
┃ MAO NAMBAHIN DOMAIN ? CHAT SALEH🤖
┃
┗━❁━┈━❁━┈━❁━┈━❁━┛
...
case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Antilink`, '© Saleh-MD', m)
                }
             }
             break
...
case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nExample : ${prefix + command} Saleh-Botz`
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      kurr.send5ButImg(i, txt, '© SalehBotz', global.thumb, btn)
                    }
